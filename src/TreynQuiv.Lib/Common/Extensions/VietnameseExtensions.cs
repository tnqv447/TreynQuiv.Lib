...
public static class VietnameseExtensions
{
    ...
    /// <summary>
    /// Get value's number string representation in Vietnamese.
    /// <para>If <paramref name="useSymbol"/> is <see langword="true"/>, append a symbol <see langword="₫"/> after the result.</para>
    /// </summary>
    /// <remarks><em>Eg: 10000000 => "10,000,000" or "10,000,000 ₫" if using symbol.</em></remarks>
    /// <param name="value"></param>
    /// <param name="useSymbol"></param>
    /// <returns></returns>
    ...
    {
        var culture = VietnameseCulture;
        culture.NumberFormat = GetVietnamNumberFormatInfo(useSymbol);
    ...
    private static NumberFormatInfo GetVietnamNumberFormatInfo(bool useSymbol)
    {
